    ...
    return listFrom(events).map((node) {
      ...
      return Event(
        ...
        releaseDate: _parseReleaseDate(
            tagContentsOrNull(node, 'dtLocalRelease') ?? 'Not found it null'),
...
class EventImageDataParser {
  static EventImageData parse(Iterable<xml.XmlElement> roots) {
    ...
    return EventImageData(
      ...
      landscapeHd: _getHdImageUrl(landscapeBig ?? 'Not found it null'),
      landscapeHd2: _getHdImageUrl2(landscapeBig ?? 'Not found it null'),
    );
  }
