...
class EventDetailsScrollEffects {
  ...
  EventDetailsScrollEffects(BuildContext context) {
    updateScrollOffset(context, 0.0);
    _scrollOffset = 0.0;
    backdropHeight = 0.0;
    backdropOverlayOpacity = 0.0;
    backdropOverlayBlur = 0.0;
    headerOffset = 0.0;
    backButtonOpacity = 1.0;
    statusBarHeight = 0.0;
  }
  ...
  late double backdropOverlayOpacity;
  late double backdropOverlayBlur;
